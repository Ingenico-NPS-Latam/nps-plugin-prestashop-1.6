...
{if $status == 'ok'}
	<p class="alert alert-success">{l s='Your order on %s is complete.' sprintf=$shop_name mod='nps'}</p>
    <div class="box order-confirmation">
    <h3 class="page-subheading">{l s='Payment has been accepted:' mod='nps'}</h3>
		- {l s='Payment ammount.' mod='nps'} <span class="price"><strong>{$total_to_pay}</strong></span>
