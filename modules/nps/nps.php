...
class Nps extends PaymentModule
{
  ...
  private static function createMenu() 
  {
    ...
    $query .= "INSERT INTO `"._DB_PREFIX_."tab` (`id_parent`, `class_name`, `module`, `position`, `active`) VALUES (0, 'AdminParentNps', '', 9, 1);";
    $query .= "set @ADMIN_PARENT_NPS_ID = LAST_INSERT_ID();";
    foreach(Language::getLanguages() as $lang) {
      $query .= "INSERT INTO `"._DB_PREFIX_."tab_lang` (`id_tab`, `id_lang`, `name`) VALUES (@ADMIN_PARENT_NPS_ID, ".$lang['id_lang'].", 'NPS');";
    }

    $query .= "INSERT INTO `"._DB_PREFIX_."tab` (`id_parent`, `class_name`, `module`, `position`, `active`) VALUES (@ADMIN_PARENT_NPS_ID, 'AdminNps', '', 1, 1);";
    foreach(Language::getLanguages() as $lang) {
      $query .= "INSERT INTO `"._DB_PREFIX_."tab_lang` (`id_tab`, `id_lang`, `name`) VALUES (LAST_INSERT_ID(), ".$lang['id_lang'].", 'Orders');";
    }

    $query .= "INSERT INTO `"._DB_PREFIX_."tab` (`id_parent`, `class_name`, `module`, `position`, `active`) VALUES (@ADMIN_PARENT_NPS_ID, 'AdminInstallments', '', 2, 1);";
    foreach(Language::getLanguages() as $lang) {
      $query .= "INSERT INTO `"._DB_PREFIX_."tab_lang` (`id_tab`, `id_lang`, `name`) VALUES (LAST_INSERT_ID(), ".$lang['id_lang'].", 'Installments');";
    }        
    ...
    try
    {
      ...
      if($shippingAddress->firstname
        ...
        $psp_parameters['psp_ShippingDetails'] = array(
          ...
          'FreightAmount' => (int)$this->context->cart->getOrderShippingCost() > 0 ? substr((string)$this->context->cart->getOrderShippingCost(),0,12) : null,
...
array('value' => 131, 'name' => 'Carnet Debit'),
array('value' => 130, 'name' => 'Carnet'),
array('value' => 129, 'name' => 'Colsubsidio'),
...
array('value' => 101, 'name' => 'Discover'),
array('value' => 95, 'name' => 'Coopeplus'),
array('value' => 93, 'name' => 'Sucredito'),
array('value' => 91, 'name' => 'Credi Guia'),
array('value' => 75, 'name' => 'Mira'),
array('value' => 72, 'name' => 'Consumax'),
array('value' => 69, 'name' => 'Cetelem'),
